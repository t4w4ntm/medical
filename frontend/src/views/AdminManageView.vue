        ...
        <div class="relative bg-white rounded-2xl shadow-xl w-full max-w-md p-8 transform transition-all">
            ...
            <form @submit.prevent="handleCreateAdmin" class="space-y-4">
                ...
                <div>
                    ...
                    <input v-model="newPassword" type="password" class="w-full p-3 bg-slate-50 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 font-medium" placeholder="••••••••" required />
                </div>
